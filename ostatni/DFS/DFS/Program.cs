...
namespace DFS
{
    internal class Program
    {
         ...
         */
        static List<int> DepthFirstSearch(BinaryTree graph, int targetNodeIndex, int depth)
        {
            ...
            {                
                ...
                else
                {
                    ...
                    {
                        counter++;
                        currentNode.children[1].index = counter;
        ...
        static void Main(string[] args)
        {
            ...
            List<int> path = DepthFirstSearch(binaryTree, randomNodeIndex, treeDepth);
